...
<body>
    <main>
        <div class="container d-flex flex-column row-gap-3 px-0 induk">
            <!-- burger navbar -->
            <nav class="navbar sticky-top bg-body-tertiary d-lg-none rounded boxShadowCard">
                <div class="container-fluid">
                    <button class="btn btn-outline-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasResponsiveNav" aria-controls="offcanvasResponsive"><i class="bi bi-list"></i></button>
                    <button class="btn btn-primary fs-5" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasResponsiveProfile" aria-controls="offcanvasResponsive"><i class="bi bi-box-arrow-in-right"></i> Let's Talk</button>
                </div>
            </nav>
            <div class="offcanvas-lg offcanvas-start" tabindex="-1" id="offcanvasResponsiveNav" aria-labelledby="offcanvasResponsiveLabel">
                <div class="offcanvas-header">
                    <h5 class="offcanvas-title" id="offcanvasResponsiveLabel">ffferSite</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="offcanvas" data-bs-target="#offcanvasResponsiveNav" aria-label="Close"></button>
                </div>
                <div class="offcanvas-body d-lg-none">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <a class="btn fw-medium" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .25rem; --bs-btn-font-size: 1rem; width: 97%; color:var(--bs-link-color);" aria-current="page" href="/"><i class="bi bi-house fs-4"></i><br>Home</a>
                        </li>
                        <li class="list-group-item">
                        <a class="btn fw-medium" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .25rem; --bs-btn-font-size: 1rem; width: 97%; color:var(--bs-link-color);" aria-current="page" href="/about"><i class="bi bi-person-circle fs-4"></i><br>About</a>
                        </li>
                        <li class="list-group-item">
                        <a class="btn fw-medium" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .25rem; --bs-btn-font-size: 1rem; width: 97%; color:var(--bs-link-color);" aria-current="page" href="/project"><i class="bi bi-file-earmark-code fs-4"></i><br>Project</a>
                        </li>
                        <li class="list-group-item">
                        <a class="btn fw-medium" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .25rem; --bs-btn-font-size: 1rem; width: 97%; color:var(--bs-link-color);" aria-current="page" href="/contact"><i class="bi bi-telephone fs-4"></i><br>Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="offcanvas-lg offcanvas-end" tabindex="-1" id="offcanvasResponsiveProfile" aria-labelledby="offcanvasResponsiveLabel">
                <div class="offcanvas-header">
                    <h5 class="offcanvas-title" id="offcanvasResponsiveLabel">Let's Talk</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="offcanvas" data-bs-target="#offcanvasResponsiveProfile" aria-label="Close"></button>
                </div>
                <div class="offcanvas-body d-lg-none d-flex justify-content-center">
            ...
            <div class="container">
                <div class="row d-flex flex-row column-gap-4 justify-content-center">
                    <div class="col col-sm-auto d-none d-lg-flex p-0 text-center">
                    ...
                    <div class="col col-md-auto p-0">
                        <div class="card d-none d-lg-block boxShadow" style="width: 20rem;">
                            <img src="../assets/img/profile.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">Mohamad Ferdiansyah</h5>
                                <p class="card-text">Hello, I am a PPLG student at Wikrama Vocational High School and i'm a <b>Web Developer</b> with a 1 years experience</p>
